...
const ViewBus=()=>{
    ...
    useEffect(()=>{
        axios.get("http://localhost:8080/allBus").then(
            (posRes)=>{
                const {data}=posRes;
                setArr(data);
            },(errRes)=>{
                                ...
                                <>
                                    <div className=" flex ml-[-3%] " >
                                        <div className=" mt-[-1.5%] " >
                                            <div className="  md:w-[1450px] md:h-[120px] md:ml-[6%] md:mt-10 bg-[#A9B9CA] rounded-[10px] border-l-[6px] border-r-[6px] border-[#1e2f43] key={index} " >
